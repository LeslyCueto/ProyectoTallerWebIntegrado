        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    String idusu = (String) request.getAttribute("idusu");
                    Usuarios u = dao.Obtener(idusu);
                    %>
                 ...
                 <div class="form-group">
                   ...
                   <input name="idUsuario" type="text" class="form-control" id="idUsuario" readonly value="<%= u.getIdUsuario() %>" enab>
                 </div>
                 <div class="form-group">
                   <label for="exampleInputEmail1">Nombres</label>
                   <input name="nombre_usuario" type="text" class="form-control" id="nombre_usuario" value="<%= u.getNombre() %>">
                 </div>
                 <div class="form-group">
                  <label for="exampleInputPassword1">Apellidos</label>
                  <input name="apellido_usuario" type="text" class="form-control" id="apellido_usuario" value="<%= u.getApellido() %>">
                 </div>
                 <div class="form-group">
                  <label for="exampleInputPassword1">Contraseña</label>
                  <input name="passcode" type="text" class="form-control" id="passcode" value="<%= u.getPasscode() %>">
                 </div>    
                 <div class="form-group">
                  <label for="exampleInputPassword1">Dni</label>
                  <input name="usuario_dni" type="text" class="form-control" id="usuario_dni" value="<%= u.getDni() %>">
                 </div>
                 <div class="form-group">
                  <label for="exampleInputPassword1">Dirección</label>
                  <input name="direccion" type="text" class="form-control" id="direccion" value="<%= u.getDireccion() %>">
                 </div>
                 <div class="form-group">
                  <label for="exampleInputPassword1">Teléfono</label>
                  <input name="telefono" type="text" class="form-control" id="telefono" value="<%= u.getTelefono() %>">
                 </div>
